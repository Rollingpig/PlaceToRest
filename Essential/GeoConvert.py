...
本模块来源于网络，用于不同标准坐标系之间的转换。
源：
2017年07月26日 10:15:41 源哥说
...
def bd09_to_wgs84(lng, lat):
    m_lng, m_lat = bd09togcj02(lng, lat)
    return gcj02towgs84(m_lng, m_lat)
...
if __name__ == '__main__':
    alng, alat = bd09togcj02(106.726349, 26.577296)
    print(alng, alat)
    blng, blat = gcj02towgs84(alng, alat)
    print(blng, blat)
